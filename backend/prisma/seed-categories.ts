    ...
    subcategories: [
      {
        ...
        order: 1,
        subsubcategories: [
          { nameAr: 'توشيبا', nameEn: 'Toshiba Refrigerators', slug: 'toshiba-refrigerators', order: 1 },
          { nameAr: 'شارب', nameEn: 'Sharp Refrigerators', slug: 'sharp-refrigerators', order: 2 },
          { nameAr: 'إل جي', nameEn: 'LG Refrigerators', slug: 'lg-refrigerators', order: 3 },
          { nameAr: 'سامسونج', nameEn: 'Samsung Refrigerators', slug: 'samsung-refrigerators', order: 4 },
          { nameAr: 'كريازي', nameEn: 'Kiriazi Refrigerators', slug: 'kiriazi-refrigerators', order: 5 },
          { nameAr: 'ثلاجات أخرى', nameEn: 'Other Refrigerators', slug: 'other-refrigerators', order: 6 },
        ],
      },
      {
        nameAr: 'غسالات',
        ...
        order: 2,
        subsubcategories: [
          { nameAr: 'غسالة توشيبا', nameEn: 'Toshiba Washing Machines', slug: 'toshiba-washing', order: 1 },
          { nameAr: 'غسالة إل جي', nameEn: 'LG Washing Machines', slug: 'lg-washing', order: 2 },
          { nameAr: 'غسالة سامسونج', nameEn: 'Samsung Washing Machines', slug: 'samsung-washing', order: 3 },
          { nameAr: 'زانوسي', nameEn: 'Zanussi Washing Machines', slug: 'zanussi-washing', order: 4 },
          { nameAr: 'وايت ويل', nameEn: 'White Whale', slug: 'white-whale-washing', order: 5 },
          { nameAr: 'غسالات أخرى', nameEn: 'Other Washing Machines', slug: 'other-washing', order: 6 },
        ],
      },
      {
        nameAr: 'مكيفات',
        ...
        order: 3,
        subsubcategories: [
          { nameAr: 'كارير', nameEn: 'Carrier AC', slug: 'carrier-ac', order: 1 },
          { nameAr: 'شارب', nameEn: 'Sharp AC', slug: 'sharp-ac', order: 2 },
          { nameAr: 'إل جي', nameEn: 'LG AC', slug: 'lg-ac', order: 3 },
          { nameAr: 'ميديا', nameEn: 'Midea AC', slug: 'midea-ac', order: 4 },
          { nameAr: 'يونيون اير', nameEn: 'Union Air', slug: 'union-air', order: 5 },
          { nameAr: 'مكيفات أخرى', nameEn: 'Other AC', slug: 'other-ac', order: 6 },
        ],
      },
      {
        nameAr: 'أفران ومواقد',
        ...
        order: 4,
        subsubcategories: [
          { nameAr: 'فريش', nameEn: 'Fresh', slug: 'fresh-ovens', order: 1 },
          { nameAr: 'إيديال', nameEn: 'Ideal', slug: 'ideal-ovens', order: 2 },
          { nameAr: 'يونيفرسال', nameEn: 'Universal', slug: 'universal-ovens', order: 3 },
          { nameAr: 'أفران أخرى', nameEn: 'Other Ovens', slug: 'other-ovens', order: 4 },
        ],
      },
      {
        nameAr: 'أدوات مطبخ',
        ...
        order: 5,
        subsubcategories: [
          { nameAr: 'ميكروويف', nameEn: 'Microwave', slug: 'microwave', order: 1 },
          { nameAr: 'ديب فريزر', nameEn: 'Deep Freezer', slug: 'deep-freezer', order: 2 },
          { nameAr: 'غلاية', nameEn: 'Electric Kettle', slug: 'electric-kettle', order: 3 },
          { nameAr: 'مكنسة كهربائية', nameEn: 'Vacuum Cleaner', slug: 'vacuum-cleaner', order: 4 },
          { nameAr: 'سخان مياه', nameEn: 'Water Heater', slug: 'water-heater', order: 5 },
        ],
      },
    ],
  },
