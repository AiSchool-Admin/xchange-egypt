...
export const NotificationType = {
  ...
  AUCTION_WINNING: 'AUCTION_WINNING',
  AUCTION_WON: 'AUCTION_WON',
  AUCTION_LOST: 'AUCTION_LOST',
  AUCTION_ENDING_SOON: 'AUCTION_ENDING_SOON',
  AUCTION_ENDED: 'AUCTION_ENDED',
  // Reverse Auction notifications
  REVERSE_AUCTION_NEW_REQUEST: 'REVERSE_AUCTION_NEW_REQUEST',
  REVERSE_AUCTION_NEW_BID: 'REVERSE_AUCTION_NEW_BID',
  REVERSE_AUCTION_OUTBID: 'REVERSE_AUCTION_OUTBID',
  REVERSE_AUCTION_WINNING: 'REVERSE_AUCTION_WINNING',
  REVERSE_AUCTION_WON: 'REVERSE_AUCTION_WON',
  REVERSE_AUCTION_AWARDED: 'REVERSE_AUCTION_AWARDED',
  REVERSE_AUCTION_ENDING_SOON: 'REVERSE_AUCTION_ENDING_SOON',
  // Barter notifications
  BARTER_OFFER_RECEIVED: 'BARTER_OFFER_RECEIVED',
  BARTER_OFFER_ACCEPTED: 'BARTER_OFFER_ACCEPTED',
  BARTER_OFFER_REJECTED: 'BARTER_OFFER_REJECTED',
  BARTER_OFFER_COUNTERED: 'BARTER_OFFER_COUNTERED',
  BARTER_OFFER_EXPIRED: 'BARTER_OFFER_EXPIRED',
  BARTER_MATCH: 'BARTER_MATCH',
  // Matching notifications
  PURCHASE_REQUEST_MATCH: 'PURCHASE_REQUEST_MATCH',
  SALE_TO_DEMAND: 'SALE_TO_DEMAND',
  ...
  TRANSACTION_DELIVERED: 'TRANSACTION_DELIVERED',
  // Order notifications
...
// Note: Model interfaces are generated by Prisma client
// Import them from @prisma/client instead of defining local placeholders
