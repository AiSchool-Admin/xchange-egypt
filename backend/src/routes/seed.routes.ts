    ...
    children: [
      {
        ...
        slug: 'refrigerators',
        children: [
          { nameEn: 'Toshiba Refrigerators', nameAr: 'توشيبا', slug: 'toshiba-refrigerators' },
          { nameEn: 'Sharp Refrigerators', nameAr: 'شارب', slug: 'sharp-refrigerators' },
          { nameEn: 'LG Refrigerators', nameAr: 'إل جي', slug: 'lg-refrigerators' },
          { nameEn: 'Samsung Refrigerators', nameAr: 'سامسونج', slug: 'samsung-refrigerators' },
          { nameEn: 'Kiriazi Refrigerators', nameAr: 'كريازي', slug: 'kiriazi-refrigerators' },
          { nameEn: 'Other Refrigerators', nameAr: 'ثلاجات أخرى', slug: 'other-refrigerators' },
        ],
      },
      {
        ...
        children: [
          { nameEn: 'Toshiba Washing Machines', nameAr: 'غسالة توشيبا', slug: 'toshiba-washing' },
          { nameEn: 'LG Washing Machines', nameAr: 'غسالة إل جي', slug: 'lg-washing' },
          { nameEn: 'Samsung Washing Machines', nameAr: 'غسالة سامسونج', slug: 'samsung-washing' },
          { nameEn: 'Zanussi Washing Machines', nameAr: 'زانوسي', slug: 'zanussi-washing' },
          { nameEn: 'White Whale', nameAr: 'وايت ويل', slug: 'white-whale-washing' },
          { nameEn: 'Other Washing Machines', nameAr: 'غسالات أخرى', slug: 'other-washing' },
        ],
      },
      {
        ...
        children: [
          { nameEn: 'Carrier AC', nameAr: 'كارير', slug: 'carrier-ac' },
          { nameEn: 'Sharp AC', nameAr: 'شارب', slug: 'sharp-ac' },
          { nameEn: 'LG AC', nameAr: 'إل جي', slug: 'lg-ac' },
          { nameEn: 'Midea AC', nameAr: 'ميديا', slug: 'midea-ac' },
          { nameEn: 'Union Air', nameAr: 'يونيون اير', slug: 'union-air' },
          { nameEn: 'Other AC', nameAr: 'مكيفات أخرى', slug: 'other-ac' },
        ],
      },
      {
        nameEn: 'Ovens & Stoves',
        ...
        slug: 'ovens-stoves',
        children: [
          { nameEn: 'Fresh', nameAr: 'فريش', slug: 'fresh-ovens' },
          { nameEn: 'Ideal', nameAr: 'إيديال', slug: 'ideal-ovens' },
          { nameEn: 'Universal', nameAr: 'يونيفرسال', slug: 'universal-ovens' },
          { nameEn: 'Other Ovens', nameAr: 'أفران أخرى', slug: 'other-ovens' },
        ],
      },
      {
        ...
        children: [
          { nameEn: 'Microwave', nameAr: 'ميكروويف', slug: 'microwave' },
          { nameEn: 'Deep Freezer', nameAr: 'ديب فريزر', slug: 'deep-freezer' },
          { nameEn: 'Electric Kettle', nameAr: 'غلاية', slug: 'electric-kettle' },
          { nameEn: 'Vacuum Cleaner', nameAr: 'مكنسة كهربائية', slug: 'vacuum-cleaner' },
          { nameEn: 'Water Heater', nameAr: 'سخان مياه', slug: 'water-heater' },
        ],
      },
    ],
  },
