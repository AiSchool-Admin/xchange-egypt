...
const QUICK_ACTIONS = [
  { href: "/mobile/sell", icon: Plus, title: "بيع موبايلك", desc: "أضف إعلانك الآن", gradient: "from-emerald-500 to-teal-600" },
  { href: "/mobile/listings", icon: Search, title: "تصفح الموبايلات", desc: "ابحث عن جهازك", gradient: "from-blue-500 to-indigo-600" },
  { href: "/mobile/barter", icon: ArrowLeftRight, title: "مقايضة", desc: "بدّل جهازك", gradient: "from-purple-500 to-violet-600" },
  { href: "/mobile/my-listings", icon: Package, title: "إعلاناتي", desc: "إدارة منتجاتك", gradient: "from-amber-500 to-orange-600" },
];

// User account links
const USER_LINKS = [
  { href: "/mobile/my-listings", icon: Package, title: "إعلاناتي", desc: "إدارة إعلاناتك" },
  { href: "/mobile/my-barters", icon: ArrowLeftRight, title: "مقايضاتي", desc: "عروض المقايضة" },
  { href: "/mobile/transactions", icon: Gavel, title: "معاملاتي", desc: "سجل المعاملات" },
  { href: "/mobile/disputes", icon: MessageSquare, title: "النزاعات", desc: "حل المشكلات" },
];
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="max-w-2xl mx-auto mb-8">
              <div className="relative">
                ...
                <Link
                  href={`/mobile/listings?q=${searchQuery}`}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
            {FEATURED_BRANDS.map((item) => (
              <Link
                key={item.brand}
                href={`/mobile/listings?brand=${item.brand}`}
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              href="/mobile/listings?featured=true"
              className="flex items-center gap-1 text-blue-600 hover:text-blue-700 font-medium"
            >
              عرض الكل
              <ChevronLeft className="w-4 h-4" />
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">/mobile/sell</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">/mobile/listings</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">/mobile/barter</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">/mobile/my-listings</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">/mobile/my-barters</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">/mobile/transactions</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">/mobile/disputes</p>
                </div>
              </div>
            </Link>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/mobile/sell" className="hover:text-white">بيع موبايل</Link></li>
                <li><Link href="/mobile/listings" className="hover:text-white">تصفح الإعلانات</Link></li>
                <li><Link href="/mobile/barter" className="hover:text-white">المقايضة</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-bold mb-4">حسابي</h3>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/mobile/my-listings" className="hover:text-white">إعلاناتي</Link></li>
                <li><Link href="/mobile/my-barters" className="hover:text-white">مقايضاتي</Link></li>
                <li><Link href="/mobile/transactions" className="hover:text-white">المعاملات</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-bold mb-4">الماركات الشهيرة</h3>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/mobile/listings?brand=APPLE" className="hover:text-white">آبل</Link></li>
                <li><Link href="/mobile/listings?brand=SAMSUNG" className="hover:text-white">سامسونج</Link></li>
                <li><Link href="/mobile/listings?brand=XIAOMI" className="hover:text-white">شاومي</Link></li>
              </ul>
            </div>
          </div>
